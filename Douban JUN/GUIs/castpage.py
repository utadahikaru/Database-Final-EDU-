...
class castsel():
    ...
    def etgetsel(self):
        ...
        resultscore = '7.5'
        print(resultscore)
        self.scoreLabel = Label(castselTk, text=resultscore,
                                font=('Helvetica', 34), bg=mycolor, fg='white')
        ...
        userLoveRate = ''' SELECT userLoveRate FROM  usersLove  WHERE userId ='%s' and castId='%s' ''' % (
            userId, castId)
